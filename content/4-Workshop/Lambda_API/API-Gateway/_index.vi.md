...
![Tạo API](/images/workshop/AG1.png)

3. Cấu hình:
   - **API name:** `workshop-api`
   - **Endpoint type:** Regional

![Cấu hình API](/images/workshop/AG2.png)

4. Nhấn **Create API**. Bạn sẽ thấy resource gốc `/`.

![Resource gốc](/images/workshop/AG3.png)
...
![Tạo resource login](/images/workshop/AG4.png)
...
![Tạo POST /login](/images/workshop/AG5.png)
...
5. Nhấn **Save** → **OK**
![Tạo POST /login](/images/workshop/getsongapi.png)
...
![Tạo Cognito Authorizer](/images/workshop/auth1.png)
![Tạo Cognito Authorizer](/images/workshop/auth2.png)
![Tạo Cognito Authorizer](/images/workshop/auth3.png)
...
4. Nhấn dấu ✓ để lưu
![Tạo Cognito Authorizer](/images/workshop/meth1.png)
![Tạo Cognito Authorizer](/images/workshop/meth42.png)
...
![Tạo Cognito Authorizer](/images/workshop/cors1.png)
![Tạo Cognito Authorizer](/images/workshop/cors2.png)
